...
class HomeScreen extends StatefulWidget {
  ...
  HomeScreen({required this.postCode, required this.donorId, Key? key})
      : super(key: key);
            ...
            children: [
              Expanded(
                child: GetBuilder<DataController>(builder: (controller) {
                  return controller.getData.length != 0
                      ? ListView.builder(
                            ...
                            return controller.getData[index].donorNo == widget.donorId &&
                                ...
                                ? Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        controller.getData[index].donorNo
                                            .toString(),
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          AppConstant.urlCreator(
                                              paymentUrl: Uri.parse(
                                                  'https://www.farplace.org.uk/how-to-help/donations/'));
                                        },
                                        child: Container(
                                          height: 30,
                                ...
                                : limit
                                    ...
                                    : limit == false &&
                                        ...
                                        ? Container(
                                            ...
                                            child: const Center(
                                                child: Text(
                                              "DonorID or PostCode have been not matched",
                                            )))
                                        : Container(
                                            child: Text(""),
                                          );
